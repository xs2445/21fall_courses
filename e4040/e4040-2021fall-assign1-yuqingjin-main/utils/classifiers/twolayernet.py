...
class TwoLayerNet(object):
    ...
    def loss(self, X, y):
        ...
        W1, b1= self.layer1.params[0], self.layer1.params[1]
        W2, b2 = self.layer2.params[0], self.layer2.params[1]
        ...
        # scores = affine_forward(hidden_layer, W2, b2)
        ...
        # print(W2.shape)
        # print(b2.shape)
        # print("hello", dX1.shape)

        dW2 += self.reg * W2

        # Backprop into first layer
        da = relu_backward(dX1, hidden_layer)
        # print(b1.shape)
        dX, dW1, db1 = affine_backward(da, X, W1, b1)
        dW1 += self.reg * W1

        self.layer1.gradients = [dW1, db1]
        self.layer2.gradients = [dW2, db2]
        # self.layer1.velocity = [1, 1]
        # self.layer2.velocity = [1, 1]

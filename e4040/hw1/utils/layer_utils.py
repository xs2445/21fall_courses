...
class DenseLayer(FullyConnectedLayer):
    ...
    def feedforward(self, X):
        ...
        print('./utils/layer_utils.DenseLayer.feedforward() not implemented!') # delete me
    ...
    def backward(self, dout):
        ...
        print('./utils/layer_utils.DenseLayer.backward() not implemented!') # delete me
...
class AffineLayer(FullyConnectedLayer):
    ...
    def feedforward(self, X):
        ...
        print('./utils/layer_utils.AffineLayer.feedforward() not implemented!') # delete me
    ...
    def backward(self, dout):
        ...
        print('./utils/layer_utils.AffineLayer.backward() not implemented!') # delete me
